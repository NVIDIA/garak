...
const DefconSummaryPanel = ({ modules }: DefconSummaryPanelProps) => {
  ...
  if (summary.critical.length > 0) {
    cards.push(
      <div key="critical" className="p-4 rounded-lg border-l-4 bg-red-50" style={{ borderColor: getSeverityColorByLevel(1) }}>
        <div className="flex items-center gap-4 mb-3">
          <h2 className="text-lg font-semibold text-red-900">🚨 Critical Failures</h2>
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-red-800">Module{summary.critical.length !== 1 ? 's' : ''} requiring immediate action</span>
          </div>
  ...
  if (summary.poor.length > 0) {
    cards.push(
      <div key="poor" className="p-4 rounded-lg border-l-4 bg-orange-50" style={{ borderColor: getSeverityColorByLevel(2) }}>
        <div className="flex items-center gap-4 mb-3">
          <h2 className="text-lg font-semibold text-orange-900">⚡ Poor Performance</h2>
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-orange-800">Module{summary.poor.length !== 1 ? 's' : ''} needing review</span>
          </div>
  ...
  if (!hasFailures) {
    cards.push(
      <div key="success" className="p-4 rounded-lg border-l-4 bg-green-50" style={{ borderColor: getSeverityColorByLevel(4) }}>
        <div className="flex items-center gap-4 mb-3">
        ...
        <div className="text-sm text-green-800">
          All {summary.totalModules} module{summary.totalModules !== 1 ? 's' : ''} performing acceptably
        </div>
  ...
  cards.push(
    <div key="performance" className="p-4 rounded-lg border-l-4 bg-gray-50" style={{ borderColor: getSeverityColorByLevel(3) }}>
      <div className="flex items-center gap-4 mb-3">
